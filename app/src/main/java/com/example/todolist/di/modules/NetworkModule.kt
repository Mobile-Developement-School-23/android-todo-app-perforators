...
import com.example.authorization.TokenLocalDataSource
import com.example.todo.remote.api.HeaderInterceptor
...
class NetworkModule {
    ...
    fun provideHeaderInterceptor(tokenLocalDataSource: TokenLocalDataSource): HeaderInterceptor {
        return HeaderInterceptor(tokenLocalDataSource.token.value)
    }
